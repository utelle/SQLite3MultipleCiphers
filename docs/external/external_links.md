...
- _.NET NuGet_ package [SQLite3MC.PCLRaw.bundle](https://www.nuget.org/packages/SQLite3MC.PCLRaw.bundle) ([GitHub](https://github.com/utelle/SQLite3MultipleCiphers-NuGet)) (since November 2025).  
  The _SQLite3 Multiple Ciphers NuGet_ packages are maintained by the maintainers of [SQLite3 Multiple Ciphers](https://github.com/utelle/SQLite3MultipleCiphers).
  The prior package [SQLitePCLRaw.bundle_e_sqlite3mc](https://www.nuget.org/packages/SQLitePCLRaw.bundle_e_sqlite3mc) is deprecated, because the maintainer [Eric Sink](https://github.com/ericsink/) doesn't provide up-to-date binaries for the package any longer for free - however, commercial [build service and support](https://sqlite.sourcegear.com/doc/trunk/www/sqlite_build_service.md) is [available](https://sqlite.sourcegear.com/doc/trunk/www/sqlite_build_service.md).
